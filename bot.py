...
def main():
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_INPUT: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.calc_input)]
            },
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_PERCENTAGE: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.percentage_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_FRACTION: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.fraction_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_AVERAGE: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.average_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_DISCOUNT: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.discount_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_AGE: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.age_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_DATE: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.date_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_LENGTH: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.length_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_WEIGHT: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.weight_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
    ...
    application.add_handler(
        ConversationHandler(
            ...
            states={
                WAITING_FOR_TEMPERATURE: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot_handlers.temp_input)]
            },
            fallbacks=[CommandHandler('cancel', bot_handlers.cancel)]
        )
    )
